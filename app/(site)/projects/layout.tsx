      ...
      <body className={inter.className}>
        ...
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          <div className="mx-auto flex max-w-screen-md flex-col gap-12 md:border-l md:border-r">
            <div className="fixed left-4 right-4 top-4 z-50 mx-auto flex flex-wrap items-center justify-center justify-self-center rounded-full border bg-white bg-white/50 px-3 align-middle backdrop-blur-lg dark:bg-black dark:bg-black/50 ">
              {/* <Link
