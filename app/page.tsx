      ...
      <div className="container p-12 lg:p-24">
        <div className="mb-24 flex w-full flex-row items-center justify-between gap-4">
          <div className="flex flex-col">
            ...
            <p className={`max-w-[30ch] text-sm text-stone-500`}>
              Software Designer
            </p>
          </div>
        ...
        <div className="mb-24 flex flex-col gap-4">
          ...
          >
            {[
              ["/starterkit1.png", "StarterKit"],
              ["/starterkit2.png", "StarterKit"],
              ["/starterkit3.png", "StarterKit"],
              ["/starterkit4.png", "StarterKit"],
            ].map(([file, alt]) => (
              <Image
                className="rounded"
                src={file}
        ...
        <div className="mb-24 flex flex-col gap-4">
          <motion.div
            ...
            className="flex cursor-pointer flex-row items-center gap-4 overflow-auto rounded-3xl bg-stone-100 p-8 transition-colors dark:border-stone-700 dark:bg-stone-800/30 lg:p-12"
          >
            {[["/field-states-2021.svg", "Field States"]].map(
              ([file, name]) => (
                <Image
                  className="rounded"
                  src={file}
        ...
        <div className="mb-24 flex flex-col gap-4">
          ...
          >
            {[["/chrome-wireframe-2023.svg", "Variants Panel"]].map(
              ([file, name]) => (
                <Image
                  className="rounded"
                  src={file}
